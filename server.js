...
app.get('/petrol-bill-generator', (req, res) => res.sendFile(path.join(ROOT, 'petrol-bill-generator.html')));
app.get('/diesel-bill-generator', (req, res) => res.sendFile(path.join(ROOT, 'diesel-bill-generator.html')));
app.get('/fuel-bill-format',      (req, res) => res.sendFile(path.join(ROOT, 'fuel-bill-format.html')));
