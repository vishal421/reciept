...
// __dirname = wherever server.js lives = .../mainfolder/
// All files (home.html, index.html, assets/, templates/) are siblings of server.js
const ROOT = __dirname;

app.use(express.json({ limit: '2mb' }));

// Serve static files (assets/, templates/, etc.)
